      ...
      <div className='flex flex-col max-w-sm lg:max-w-3xl mx-auto bg-gray-900'>
        {showMore ? (
          ...
          <div className='text-4xl text-white'>
            ...
            {submitForm && (
                <div class="flex items-center p-4 mb-4 mt-44 text-sm text-red-800 border border-red-300 rounded-lg ease-in bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
            ...
            <label htmlFor='message' className='block mb-2 mt-44 text-sm font-medium text-gray-900 dark:text-white'>
              Price
            </label>
            <CurrencyInput
              id='input-example'
